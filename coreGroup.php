...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div class="exr-container">
      ...
      <form method="POST" action="coreGroup.php" style="grid-column: 1 / span 2">
...
<?php 
    ...
    $sqlcreate =
        ...
        KEY `coregroup_FK` (`userId`),
        CONSTRAINT `coregroup_FK` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
    //validate creation
    if ($GLOBALS["dbconnect"]->query($sqlcreate) === TRUE) {
        //echo("Table 'coregroup' created successfully. ");
    } else {
        echo("Error creating table 'coregroup'. ");
    };
    ...
    if(isset($_POST['enterNew'])){
        ...
        $sql = ("INSERT INTO coregroup (`userId`,`exerciseType`,`exrLog`) VALUES (?,?,?)");
    ...
    $sql = "SELECT exerciseType FROM coregroup";
    $result = $GLOBALS["dbconnect"]->query($sql);
